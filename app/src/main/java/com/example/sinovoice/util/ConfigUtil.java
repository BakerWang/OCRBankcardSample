...
public class ConfigUtil {
    ...
    //身份证识别功能
    public static final String CAP_KEY_OCR_LOCAL_TEMPLATE = "ocr.local.bankcard.v7";
    //名片识别功能
    public static final String CAP_KEY_OCR_LOCAL_BIZCARD = "ocr.local.bankcard.v7";
    //本地文本图片识别功能
    public static final String CAP_KEY_OCR_LOCAL_RECOG= "ocr.local.bankcard.v7";
}
